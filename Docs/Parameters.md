...
| **QpScaleCompressStrength**      | --qp-scale-compress-strength     | [0-8]      | 3           | Sets the QP compression strength resulting in less quality variation across frames in a mini-gop [0: off, 1: SVT-AV1-PSY default, 8: maximum]        |
